...
namespace Tests.Arcanum.ForNewtonsoftJson {
	...
	public sealed class TestUnions: ArcanumJsonContractResolverTest {
		...
		public void JsonObjectCaseIsDeserialized () {
			...
			var actual = serializer.Deserialize<UnionExample>(tokenReader);
		...
		public void JsonArrayCaseIsSerialized () {
			...
			using var tokenWriter = new JTokenWriter();
			serializer.Serialize(tokenWriter, subject);
			var actualToken = tokenWriter.Token;
		...
		public void LeafCaseIsDeserializedAsMediumCase () {
			...
			using var tokenReader = new JTokenReader(token);
			var actual = serializer.Deserialize<UnionExample.MediumCase>(tokenReader);
		...
		public void LeafCaseIsDeserializedAsItself () {
			...
			using var tokenReader = new JTokenReader(token);
			var actual = serializer.Deserialize<UnionExample.MediumCase.LeafCase>(tokenReader);
		...
		public void UnionContainerIsDeserialized () {
			...
			using var tokenReader = new JTokenReader(token);
			var actual = serializer.Deserialize<UnionContainerExample>(tokenReader);
